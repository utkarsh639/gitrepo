        ...
        <Modal.Body>
          <table>
            ...
            {coke !== 0 && <tr>
              <td>Coke</td>
              <td>
                <button onClick={() => { if (coke) setCoke(coke - 1)}} className="btn2">
                  -
                </button>
                {" "}{coke}{" "}
            ...
            {hamburger !== 0 && <tr>
              <td>Hamburger</td>
             <td>
                <button onClick={() => { if (hamburger) setHamburger(hamburger - 1)}} className="btn2">
                  -
                </button>
                {" "}{hamburger}{" "}
            ...
            {fries !== 0 && <tr>
              <td>Fries</td>
               <td>
                <button onClick={() => { if (fries) setFries(fries - 1)}} className="btn2">
                  -
                </button>
                {" "}{fries}{" "}
